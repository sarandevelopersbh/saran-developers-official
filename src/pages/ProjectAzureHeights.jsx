...
export default function ProjectAzureHeights() {
        ...
        <div className="absolute bottom-0 left-0 w-full p-6 md:p-20 bg-gradient-to-t from-black/90 via-black/40 to-transparent">
          <div className="container mx-auto">
             <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }}>
               <h1 className="text-5xl md:text-8xl font-serif text-white mb-6 leading-none">Azure Heights</h1>
               <div className="flex flex-wrap items-center text-white/90 gap-8 text-sm tracking-widest uppercase font-medium">
                 <span className="flex items-center gap-2"><MapPin size={16} className="text-amber-500" /> San Francisco, CA</span>
                 <span className="flex items-center gap-2"><Calendar size={16} className="text-amber-500" /> 2020</span>
               </div>
             </motion.div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 py-24">
          <div className="lg:col-span-8">
            ...
            <div className="prose prose-lg prose-stone font-serif prose-p:text-neutral-600 prose-p:leading-loose max-w-none mb-16">
               <p>Urban luxury redefined. A vertical sanctuary offering the finest amenities and bespoke interior design. Located in the prestigious Pacific Heights, Azure Heights offers commanding views of the bay and city skyline.</p>
            </div>
            ...
            <div className="mt-20 border-t border-stone-200 pt-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
                <div>
                   <div className="flex items-start gap-4 mb-6">
                      ...
                      <div>
                        <h4 className="font-serif text-lg font-bold mb-2">High-Rise Logistics</h4>
                        <p className="text-neutral-600 text-sm leading-relaxed">
                          <strong>Challenge:</strong> Executing a complete structural retrofit on the 42nd floor with limited elevator capacity and strict HOA noise regulations.
                          <br /><br />
                          <strong>Solution:</strong> We coordinated helicopter lifts for steel beams during off-peak hours and utilized modular acoustic dampening panels to isolate construction noise, finishing 2 weeks ahead of schedule.
                        </p>
                      </div>
                   </div>
                </div>
                <div>
                   <div className="flex items-start gap-4 mb-6">
                      ...
                      <div>
                        <h4 className="font-serif text-lg font-bold mb-2">Seismic Engineering</h4>
                        <p className="text-neutral-600 text-sm leading-relaxed">
                          <strong>Challenge:</strong> Installing heavy marble slabs and floor-to-ceiling glass in a high-seismic zone required flexible mounting solutions.
                          <br /><br />
                          <strong>Solution:</strong> We engineered a floating sub-frame system for the stone cladding and used seismic-rated glazing channels that allow for independent movement during tremors.
                        </p>
                      </div>
                   </div>
                </div>
              ...
              <div className="space-y-6">
                 ...
                 <BeforeAfterSlider 
                    beforeImage="https://unsplash.com/photos/a-group-of-men-standing-on-top-of-a-pile-of-metal-6CT4cYdSNaI?q=80&w=2000&auto=format&fit=crop"
                    afterImage="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhBB-wztcJ9vt9DhaHgZaw0D9ZZaXdJnH21yqWQuF8b3rrlDoCgkYgTJLtHLoW-XwQeEVeQ7Zznhjuu036QmHTnulQNfuAsvXg4EJM6imHpRDIryYoZ1pDZj0aQ1nCquQ0p9jXXGgAexoxtSb1s0iS2ELNlpb4wzvWv4E7_0oSiYMH05h3ydRb6uYgmE5mP/w640-h350/high-rise-luxury-tower-development-san-francisco-skyline.png"
                    alt="Azure Heights Transformation"
                 />
                 <p className="text-neutral-500 text-xs italic text-center">Slide to see the transformation from shell to penthouse.</p>
              </div>
            </div>
          ...
          <div className="lg:col-span-4">
            <div className="sticky top-32 space-y-12">
              <div className="bg-stone-100 p-8 border border-stone-200">
                ...
                <div className="space-y-6">
                  <div><p className="text-xs uppercase tracking-widest text-neutral-500 mb-1 flex items-center gap-2"><PenTool size={12} /> Architect</p><p className="font-medium text-lg">Studio One</p></div>
                  <div><p className="text-xs uppercase tracking-widest text-neutral-500 mb-1 flex items-center gap-2"><Maximize size={12} /> Living Area</p><p className="font-medium text-lg">4,800 sq ft</p></div>
                  <div><p className="text-xs uppercase tracking-widest text-neutral-500 mb-1 flex items-center gap-2"><Calendar size={12} /> Completed</p><p className="font-medium text-lg">2020</p></div>
                  <div><p className="text-xs uppercase tracking-widest text-neutral-500 mb-1 flex items-center gap-2"><MapPin size={12} /> Neighborhood</p><p className="font-medium text-lg">Pacific Heights</p></div>
                  <div><p className="text-xs uppercase tracking-widest text-neutral-500 mb-1 flex items-center gap-2"><PenTool size={12} /> Style</p><p className="font-medium text-lg">Urban Modern</p></div>
                </div>
              </div>
              <div>
                <h4 className="font-serif text-xl mb-6">Key Features</h4>
                <ul className="space-y-4">
                  {['Penthouse terraces', 'Concierge service', 'Private elevator access', 'Spa and wellness center'].map((feature, i) => (
