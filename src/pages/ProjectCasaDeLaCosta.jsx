        ...
        <div className="absolute bottom-0 left-0 w-full p-6 md:p-20 bg-gradient-to-t from-black/90 via-black/40 to-transparent">
          <div className="container mx-auto">
             <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }}>
               <h1 className="text-5xl md:text-8xl font-serif text-white mb-6 leading-none">Casa de la Costa</h1>
               <div className="flex flex-wrap items-center text-white/90 gap-8 text-sm tracking-widest uppercase font-medium">
                 <span className="flex items-center gap-2"><MapPin size={16} className="text-amber-500" /> Montecito, CA</span>
                 <span className="flex items-center gap-2"><Calendar size={16} className="text-amber-500" /> 2022</span>
               </div>
             </motion.div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 py-24">
          <div className="lg:col-span-8">
            ...
            <div className="prose prose-lg prose-stone font-serif prose-p:text-neutral-600 prose-p:leading-loose max-w-none mb-16">
               <p>A restoration of grandeur. <strong>Casa de la Costa</strong> pays homage to the golden age of Montecito architecture. Set on four acres of manicured gardens, this estate blends historic charm with modern luxury.</p><p>Every detail has been meticulously crafted, from the hand-painted Talavera tiles to the custom wrought-iron fixtures. The thick plaster walls provide natural insulation, while the layout encourages an effortless flow between the grand interior salons and the expansive outdoor loggias.</p>
            </div>
            ...
            <div className="mt-20 border-t border-stone-200 pt-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
                <div>
                   <div className="flex items-start gap-4 mb-6">
                      ...
                      <div>
                        <h4 className="font-serif text-lg font-bold mb-2">Historic Preservation</h4>
                        <p className="text-neutral-600 text-sm leading-relaxed">
                          <strong>Challenge:</strong> Restoring the 1920s adobe walls which had suffered significant moisture damage over decades, without compromising the original structural integrity.
                          <br /><br />
                          <strong>Solution:</strong> We sourced authentic clay from the original local quarry to synthesize a matching adobe mix and employed traditional lime plaster techniques to allow the walls to "breathe" again.
                        </p>
                      </div>
                   </div>
                </div>
                <div>
                   <div className="flex items-start gap-4 mb-6">
                      ...
                      <div>
                        <h4 className="font-serif text-lg font-bold mb-2">Modern Integration</h4>
                        <p className="text-neutral-600 text-sm leading-relaxed">
                          <strong>Challenge:</strong> Integrating a modern HVAC and smart-home system into a structure with solid masonry walls and no crawl spaces.
                          <br /><br />
                          <strong>Solution:</strong> We designed a custom high-velocity mini-duct system routed through decorative faux-beams and utilized wireless mesh technology for home automation to minimize invasive conduit runs.
                        </p>
                      </div>
                   </div>
                </div>
              ...
              <div className="space-y-6">
                 ...
                 <BeforeAfterSlider 
                    beforeImage="https://unsplash.com/photos/man-climbing-on-ladder-inside-room-Te48TPzdcU8?q=80&w=2000&auto=format&fit=crop"
                    afterImage="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgeVyfXHmN626XFR47zOGIc_T0lNr9ilcODJ9COiTiY4O9fwEgd026SD3xc5zNv5iHQHsMg8-D6tQUKkhRYX-DcTetFYjtCDzL5a808IPHOq8t-9ENtWJZOAE9ZkKZ_iwHapXIWcEl7XvOYkUcktipkRXn8VkQ7ErQ87ZNhdwFpVJg3oK37_GEd33-JJ-lX/w640-h350/spanish-colonial-revival-architecture-montecito-estate.png"
                    alt="Casa de la Costa Transformation"
                 />
                 <p className="text-neutral-500 text-xs italic text-center">Slide to see the restoration progress.</p>
              </div>
            </div>
          ...
          <div className="lg:col-span-4">
            <div className="sticky top-32 space-y-12">
              <div className="bg-stone-100 p-8 border border-stone-200">
                ...
                <div className="space-y-6">
                  <div><p className="text-xs uppercase tracking-widest text-neutral-500 mb-1 flex items-center gap-2"><PenTool size={12} /> Architect</p><p className="font-medium text-lg">Helena Vance</p></div>
                  <div><p className="text-xs uppercase tracking-widest text-neutral-500 mb-1 flex items-center gap-2"><Maximize size={12} /> Living Area</p><p className="font-medium text-lg">14,000 sq ft</p></div>
                  <div><p className="text-xs uppercase tracking-widest text-neutral-500 mb-1 flex items-center gap-2"><Calendar size={12} /> Completed</p><p className="font-medium text-lg">2022</p></div>
                  <div><p className="text-xs uppercase tracking-widest text-neutral-500 mb-1 flex items-center gap-2"><MapPin size={12} /> Neighborhood</p><p className="font-medium text-lg">Golden Quadrangle</p></div>
                  <div><p className="text-xs uppercase tracking-widest text-neutral-500 mb-1 flex items-center gap-2"><PenTool size={12} /> Style</p><p className="font-medium text-lg">Spanish Colonial Revival</p></div>
                </div>
              </div>
              <div>
                <h4 className="font-serif text-xl mb-6">Key Features</h4>
                <ul className="space-y-4">
                  {['Ocean Views', 'Subterranean Wine Cellar', 'Wellness Center', 'Hand-painted Tiles', '4-Acre Estate'].map((feature, i) => (
